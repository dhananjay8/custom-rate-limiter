...
|----------|-------|--------|
| Unit Tests (pytest) | 134 | ✅ All Passed |
...
| File | Tests | Coverage |
|------|-------|----------|
| `test_algorithms.py` | 33 | Fixed Window, Sliding Window Log, Sliding Window Counter, Token Bucket |
...
| `test_factory.py` | 7 | Algorithm + Repository factory pattern |
...
- 134 pytest tests complete in **0.63 seconds** inside the container
